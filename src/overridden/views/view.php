...
/* @var $model mgrechanik\yii2seocategory\overridden\models\activerecord\SeoCategory  */
...
$attributes = [
    ...
    [    
        'attribute' => 'name',
        'label' => Yii::t('yii2seocategory', 'Name')
    ],
    [
    ...
    [
        'attribute' => 'title',
        'label' => Yii::t('yii2seocategory', 'Title tag')
    ],
    [
        'attribute' => 'level',
...
if ($this->context->module->useSlugField) {
    array_splice($attributes, 4, 0,     [
        ['attribute' => 'slug', 'label' => Yii::t('yii2seocategory', 'Slug')]
    ]);
}
if ($this->context->module->useMetaOtherField) {
    $attributes[] =  [
        'attribute' => 'meta_other', 'label' => Yii::t('yii2seocategory', 'Other meta tags')
    ];
}
